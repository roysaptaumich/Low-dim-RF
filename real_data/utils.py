...
def plot_generated_images(gen_images, time_steps, save_dir, epoch, num_images=100, time_grid = 'geometric'):
    """
    ...
    plot_dir = os.path.join(save_dir, "gen_images" + "_" + time_grid, f"epoch_{epoch}")
    os.makedirs(plot_dir, exist_ok=True)
    # Save the plot
    plt.tight_layout()
    plot_save_path = os.path.join(plot_dir, f"disc_steps_{time_steps}.png")
